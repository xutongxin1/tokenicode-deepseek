...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'files.openedExternally': '已使用系统默认应用打开（超过 50MB 或无法在应用内预览）',
    ...
    'files.insertToChat': '插入路径到聊天',
    'files.copyPath': '复制路径',
    'files.copyDir': '复制其所在目录',
    'files.copyCurrentPath': '复制所在路径',
    'files.openInFileManager': '在 {fileManager} 中打开',
    'files.copyFile': '拷贝',
    'files.paste': '粘贴',
    'files.rename': '重命名',
    'files.delete': '删除',
    ...
    'rewind.restoreConversation': '克隆对话并恢复任务',
    'rewind.restoreAll': '恢复代码和任务',
    'rewind.restoreCode': '仅恢复代码',
    'rewind.summarize': '从此处创建摘要',
    'rewind.cancel': '取消',
    'rewind.success': '已克隆对话并回退到第 {n} 轮。发送新消息将从克隆继续。',
    ...
    'msg.deny': '拒绝',
    'msg.responded': '已响应',
    'msg.qaExpand': '展开查看问答记录',
    'msg.qaCollapse': '折叠问答记录',
    'msg.qaOptions': ' 个选项',
    'msg.qaOptionsHint': '展开查看当时的选项',
    'msg.planTitle': '执行计划',
    'msg.planSteps': '个步骤',
    ...
    'msg.questionBack': '上一步',
    'msg.questionSupplementPlaceholder': '补充说明（可选）',
    ...
    'settings.pasteFileAsPath': '粘贴文件时插入绝对路径',
  ...
  en: {
    ...
    'files.openedExternally': 'Opened with the system default app (over 50MB or not previewable in-app)',
    ...
    'files.insertToChat': 'Insert path to chat',
    'files.copyPath': 'Copy path',
    'files.copyDir': 'Copy containing folder',
    'files.copyCurrentPath': 'Copy current path',
    'files.openInFileManager': 'Open in {fileManagerEn}',
    'files.copyFile': 'Copy',
    'files.paste': 'Paste',
    'files.rename': 'Rename',
    'files.delete': 'Delete',
    ...
    'rewind.restoreConversation': 'Clone & restore task',
    ...
    'rewind.success': 'Cloned the conversation and rewound to turn {n}. Send a new message to continue from the clone.',
    ...
    'msg.qaExpand': 'Expand Q&A record',
    'msg.qaCollapse': 'Collapse Q&A record',
    'msg.qaOptions': ' options',
    'msg.qaOptionsHint': 'Expand to see the options offered',
    ...
    'msg.questionBack': 'Back',
    'msg.questionSupplementPlaceholder': 'Supplement (optional)',
    ...
    'settings.pasteFileAsPath': 'Paste files as absolute paths',
